 ...
 * [FocusInteraction.Focus] / [FocusInteraction.Unfocus].
 *
 * Emissions are serialized on [SelectionAwareEditText.focusEmitJob] so a rapid
 * focus→blur cannot deliver Focus after Unfocus.
 */
