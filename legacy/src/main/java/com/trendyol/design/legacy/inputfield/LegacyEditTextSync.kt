...
/**
 * Emits [TextFieldValue] from the view.
 *
 * [TextFieldValue.composition] (IME composing region) is not bridged: mapping EditText
 * composing spans needs InputConnection hooks and is intentionally omitted.
 */
